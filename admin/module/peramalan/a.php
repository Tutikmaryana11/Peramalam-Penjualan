		...
		<div class="row">
          ...
          <?php $idakhir = $lihat -> peramalan_row();?>
              ...
              <tr style="background:#DFF0D8;color:#333;">
                ...
                <td><input type="text" name="id_peramalan" value="<?php echo $idakhir['terakhir']; ?>" readonly></td>
              </tr>
						...
						<table class="table table-bordered" id="example1">
							...
							<tbody>
								...
								$sql =  "SELECT month(tanggal_input) as bulan , year(tanggal_input) as tahun , sum(jumlah) as stok , barang.nama_barang from nota JOIN barang on nota.id_barang=barang.id_barang JOIN kategori on barang.id_kategori=kategori.id_kategori WHERE barang.id_barang='$kategori' and tanggal_input BETWEEN '$tgl_awal' and '$tgl_akhir' GROUP by bulan, tahun, barang.nama_barang order by tahun asc, bulan asc";
